...
Scenario Outline: Login to Retail Site with multiple users 
	...
	Examples: 
		...
		Scenario: Log  out from MyAccount 
			...
			And User should see logout message 'You have been logged off your account. It is now safe to leave the computer.'
			And User should see second logout message 'Your shopping cart has been saved, the items inside it will be restored whenever you log back into your account.''
